...
window.SCENARIO_DATA = {
  ...
  fixedEvents: [
    {
      ...
      location: '教会前',
      angelExpression: 'soft',
      angelStatus: '来客の声に、静かに振り向いた',
      text: [
        '[TODO:作者差し込み] 8日目の朝。近所の人が訪ねてきて、この教会で式を挙げたいと言う。',
        '[TODO:作者差し込み] 天使様の返事。ここから14日目までの「式の準備」が始まる。',
      ],
    },
    {
      // 14日目・朝：他人の結婚式。★新郎新婦は出さない。暗転＋短い文言で流す。
      id: 'wedding_day',
      location: '礼拝堂',
      angelExpression: 'calm',
      angelStatus: '式のあいだ、ずっと祈りの側に立っていた',
      blackout: true,
      text: [
        '[TODO:作者差し込み] 式そのものは短く流す。誰が誰と結ばれたのかは書かない。',
        '[TODO:作者差し込み] 満月の夜になる日。ここは暗転のまま、数行で終える。',
      ],
    },
    {
      // 14日目・夕方：人が帰ったあとの、二人だけの礼拝堂
      id: 'wedding_after',
      location: '礼拝堂',
      angelExpression: 'gentle',
      angelStatus: '灯りを片づける手を止めて、こちらを見ている',
      text: [
        '[TODO:作者差し込み] 人が帰ったあとの礼拝堂。ろうそくの残りだけが灯っている。',
    ...
    {
      // 21日目・朝：葬儀。★スチル「祈りながら涙が頬を伝う」の差し込み位置。
      id: 'funeral',
      location: '森の木の根元',
      angelExpression: 'calm',
      angelStatus: '名を刻んだ木の前で、静かに祈っている',
      cg: 'funeral_tears',
      text: [
        '[TODO:作者差し込み] 森の木に名を刻み、根元に埋葬する。贈られたモノとともに。',
        '[TODO:作者差し込み] 天使様が故人について少し話す。ここで涙のスチルが入る。',
      ],
    },
  ],
  ...
  // 心身の余白の帯（app.js の MARGIN_CONFIG）による差し込み文。
  //   low    … 余白 0-2。天使様が止めた夜。★行動の本文をこれに差し替える
  //   mid    … 余白 3-7。行動はできたが伸びが半分。本文の後ろに足す一文
  //   lowLog / midLog … 行動ログに残す一文
  // ★止めるのは罰ではなくケア。責める調子にはしない（OPで既に実演済みの振る舞い）。
  marginNoticeTexts: {
    low: [
      '[TODO:作者差し込み] 天使様はあなたの手からそれを取り上げ、ベッドの縁に座らせた。' +
        'それ以上は何も言われなかった。',
      '[TODO:作者差し込み] 手を伸ばしたところで、そっと押し戻された。' +
        '今日はここまで、ということらしい。',
    ],
    mid: [
      '[TODO:作者差し込み] 天使様の視線を感じて、途中で手を止めた。' +
        '無理のない分だけで終わらせた。',
      '[TODO:作者差し込み] 半分ほど進めたところで、休むように促された。',
    ],
