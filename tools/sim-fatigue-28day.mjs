/* =========================================================================
   ...
   ★ かつてここに書かれていた「app.js を変えたらここも更新」という自称は
     **取り下げる**。このファイルは意図的に当時のまま凍結してある。

   乖離している主な点（2026-07-29 の確定値の適用後）:
     - restGain: 1 → **廃止（0）**。「休む」で天使様の疲労は増えない
     - talk.trust: 4 → **3**
     - trustReductionRate: 0.009 → **0.01**
     - 夜ケアの疲労回復: 固定値＋「余白14以上で追加 -2」ボーナス →
       **その夜の心身の余白から導出**（段階5／余白 0-3/4-7/8-11/12-15/16-20 → 2/3/4/5/6）。
       旧ボーナスは新しい式に吸収して廃止
